...
export const storeServiceDetailFields = [
  ...storeServiceFields,
...
export const storeServiceQueryConfig = {
  list: { defaults: storeServiceFields, isList: true },
  retrieve: { defaults: storeServiceDetailFields, isList: false }
}
