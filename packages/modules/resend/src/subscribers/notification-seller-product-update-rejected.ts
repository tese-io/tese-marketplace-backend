...
export default async function sellerProductUpdateRejectedHandler({
  event,
  container,
  ...
  await notificationService.createNotifications({
    ...
    content: {
      subject: `${storeData.store_name} - Product update rejected`,
    },
    data: {
      data: {
        product_title: title,
...
export const config: SubscriberConfig = {
  event: ProductUpdateRequestUpdatedEvent.REJECTED,
  context: {
    subscriberId: "seller-product-update-rejected-handler-resend",
  },
};
